...
void PrintMenu() {
	cout << "¬ведите 1, чтобы  выполнить функцию push" << endl;
	cout << "¬ведите 2, чтобы  выполнить функцию pop" << endl;
	cout << "¬ведите 3, чтобы  просмотреть весь стек"<< endl;
	cout << "¬ведите 4, чтобы  удалить нечЄтные элементы стэка" << endl;
	cout << "¬ведите 5, чтобы выйти из программы" << endl;
}
...
void pushToStack(STACK & a) {
		cout << "¬ведите число которое хотите добавить в стэк" << endl;
		int num;
		cin >> num;
		a.push(num);
